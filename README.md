...
![Architecture](./assets/high-level-architecture.png)
...
![Command Board](./assets/command-board.png)
...
![Robot Status](./assets/robot-status.png)
...
![Exploration Map](./assets/exploration-map.png)
...
![Debugging Logs](./assets/debugging-logs.png)
...
![Log History](./assets/log-history.png)
...
![Embedded Architecture](./assets/embedded-architecture.png)
...
![Simulation Architecture](./assets/simulation-architecture.png)
...
![Random Environment](./assets/random-environment.png)
